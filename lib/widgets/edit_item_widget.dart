...
class EditItemWdget extends StatefulWidget {
  const EditItemWdget(
      {super.key, required this.item, required this.categories});
  final Item item;
  final List<String> categories;
  @override
  State<EditItemWdget> createState() => _EditItemWidget();
}

class _EditItemWidget extends State<EditItemWdget> {
